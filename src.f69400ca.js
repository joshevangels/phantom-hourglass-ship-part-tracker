...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"ShipSeriesList.ts":[function(require,module,exports) {
"use strict";
...
var BrightSeries = {
  ...
  parts: ["Bell Prow", "Bell Anchor", "Bright Hull", "Artistic Cannon", "Arch Handrail", "Restful Cabin", "Elegant Chimney", "Paddling Wheel"],
  bonus: [0, 0, 0, 1, 1, 1, 2, 2, 3]
};
var IronSeries = {
  seriesName: "Iron Series",
  parts: ["Drill Prow", "Iron Anchor", "Iron Hull", "Strong Cannon", "Chain Handrail", "Conning Tower", "Parasol Chimney", "Battle Wheel"],
  bonus: [0, 0, 0, 1, 1, 1, 2, 2, 3]
};
var StoneSeries = {
  seriesName: "Stone Series",
  parts: ["Mermaid Prow", "Ancient Anchor", "Stone Hull", "Ancient Cannon", "Pillar Handrail", "Peaceful Bridge", "Stone Chimney", "Rock Wheel"],
  bonus: [0, 0, 0, 1, 1, 1, 2, 2, 3]
};
var VintageSeries = {
  seriesName: "Vintage Series",
  parts: ["Log Prow", "Swim Ring", "Vintage Hull", "Meager Cannon", "Worn Handrail", "Barrel Shack", "Strange Chimney", "Simple Wheel"],
  bonus: [0, 0, 0, 1, 1, 1, 2, 2, 3]
};
var DemonSeries = {
  seriesName: "Demon Series",
  parts: ["Demon Prow", "Sickle Anchor", "Demon Ship", "Fear Cannon", "Spike Handrail", "Demon Prison", "Demon Chimney", "Insect Wheel"],
  bonus: [0, 0, 0, 1, 1, 1, 2, 2, 3]
};
var TropicalSeries = {
  seriesName: "Tropical Series",
  parts: ["Tropical Prow", "Shell Anchor", "Tropical Ship", "Seapony Cannon", "Wood Handrail", "Shell Apartment", "Horn Chimney", "Shell Wheel"],
  bonus: [0, 0, 0, 1, 1, 1, 2, 2, 3]
};
var DignifiedSeries = {
  seriesName: "Dignified Series",
  parts: ["Tourist Prow", "Weighty Anchor", "Dignified Ship", "Red Cannon", "Utility Handrail", "Practical Bridge", "Tall Chimney", "Red Wheel"],
  bonus: [0, 0, 0, 1, 1, 1, 2, 2, 3]
};
var GoldenSeries = {
  seriesName: "Golden Series",
  parts: ["Golden Prow", "Gem Anchor", "Golden Hull", "Golden Cannon", "Golden Handrail", "Golden Bridge", "Golden Chimney", "Golden Wheel"],
  bonus: [0, 0, 1, 2, 2, 2, 3, 3, 4]
};
exports.AllSeries = [BrightSeries, IronSeries, StoneSeries, VintageSeries, DemonSeries, TropicalSeries, DignifiedSeries, GoldenSeries];
},{}],"components/ShipSeriesCard.component.tsx":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  ShipSeriesCard.prototype.render = function () {
    return React.createElement("div", {
      className: "ship-series-card col-sm-12 col-md-6 col-lg-3"
    }, React.createElement("div", {
      className: "title"
    }, this.props.series.seriesName), React.createElement("form", {
      className: "ship-parts"
    }, this.renderParts(this.props.series.parts)), React.createElement("div", {
      className: "ship-bonus"
    }, this.renderBonus()));
  };
  ...
  ShipSeriesCard.prototype.renderParts = function (parts) {
    ...
    return parts.map(function (part) {
      ...
      return React.createElement("label", {
        className: "ship-part ship-part-" + className,
        key: "ship-part-" + className
...
},{"react":"../node_modules/react/index.js"}],"components/Page.component.tsx":[function(require,module,exports) {
"use strict";
...
var spreadsheetLink = "https://docs.google.com/" + "spreadsheets/d/1VoeIV9eRJQIH09M5XZ-fRRq7WhfdgCxWEsEI9CiMHuA/edit#gid=1032763275";
...
function (_super) {
  ...
  Page.prototype.render = function () {
    return React.createElement("div", {
      className: "page"
    }, React.createElement("header", null, React.createElement("h2", null, "Phantom Hourglass Ship Part Tracker"), React.createElement("p", null, "inspired by", React.createElement("a", {
      className: "outer-link",
      href: spreadsheetLink
    }, " chuggaaconroy's ship part spreadsheet")), React.createElement("p", null, React.createElement("a", {
      className: "outer-link",
      href: "https://www.youtube.com/user/chuggaaconroy"
    }, "chuggaaconroy's channel"))), React.createElement("main", null, React.createElement("div", {
      className: "container"
    }, React.createElement("div", {
      className: "ship-series-cards row"
    }, this.renderShipCards()))));
  };

  Page.prototype.renderShipCards = function () {
    return ShipSeriesList_1.AllSeries.map(function (series) {
      return React.createElement(ShipSeriesCard_component_1.ShipSeriesCard, {
        key: "ship-series-" + series.seriesName,
        series: series
      });
    });
  };
...
exports.Page = Page;
},{"react":"../node_modules/react/index.js","../ShipSeriesList":"ShipSeriesList.ts","./ShipSeriesCard.component":"components/ShipSeriesCard.component.tsx"}],"index.tsx":[function(require,module,exports) {
"use strict";
...
renderRootApp();
},{"react-dom":"../node_modules/react-dom/index.js","react":"../node_modules/react/index.js","./css/main.scss":"css/main.scss","./components/Page.component":"components/Page.component.tsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
